...
public class NoteControllerTest {
        ...
        private NoteEntity noteHello = NoteEntity.builder().text("Hello world!").build();
        private NoteEntity noteBye = NoteEntity.builder().text("Bye!").build();
        private NoteEntity noteHtml = NoteEntity.builder().text("<b>Bold</b>").build();
        private NoteEntity noteJson = NoteEntity.builder().text("{ \"text\": \"Hello\" }").build();
